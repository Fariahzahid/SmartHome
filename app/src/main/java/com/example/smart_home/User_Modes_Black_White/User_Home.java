...
//        currentTime = df.format(c.getTime());
        temporery = new ProgressDialog(User_Home.this);
        ...
        automatic_mode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(User_Home.this, User_Automatic_Mode.class);
                startActivity(intent);
            }
        });
    ...
    public void onLocationChanged(Location location) {
        ...
        new User_Home.GetWeather().execute(Common.apiRequest(String.valueOf(lat), String.valueOf(lng)));
    }
