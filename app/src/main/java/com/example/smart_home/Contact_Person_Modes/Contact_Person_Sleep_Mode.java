...
public class Contact_Person_Sleep_Mode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bedroom = new Contact_Person_Sleep_Mode_Bedroom();
        livingroom = new Contact_Person_Sleep_Mode_Livingroom();
        wc = new Contact_Person_Sleep_Mode_WC();
        kitchen = new Contact_Person_Sleep_Mode_Kitchen();
       ...
       // categories.add(0,"Select Room");
        ...
        categories.add("WC");
        mSpinner = findViewById(R.id.rooms_spinner);
    ...
    public void setFragment(Fragment fragment){
        ...
        fragmentTransaction.replace(R.id.frame_sleepmode,fragment);
