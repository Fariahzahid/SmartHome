...
public class User_Manual_Mode_Kitchen extends AppCompatActivity {
    private Spinner user_room_spinner;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_user_manual_mode_kitchen);
        ...
        user_room_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(parent.getItemAtPosition(position).equals("LIVING ROOM")){
                    Intent intent = new Intent(User_Manual_Mode_Kitchen.this, User_Manual_Mode_Living_Room.class);
                    startActivity(intent);
                }
                if(parent.getItemAtPosition(position).equals("KITCHEN")){

                    Intent intent = new Intent(User_Manual_Mode_Kitchen.this, User_Manual_Mode_Kitchen.class);
                    startActivity(intent);
                }
                if(parent.getItemAtPosition(position).equals("WC")){
                    Intent intent = new Intent(User_Manual_Mode_Kitchen.this, User_Manual_Mode_WC.class);
                    startActivity(intent);
                }
            }
